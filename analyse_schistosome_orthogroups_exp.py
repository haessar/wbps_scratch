...
class OrthoGroup:
    def __init__(self, row, do_plot, load_blast, table_path):
        ...
        self.conf_path = f"data/configs/{os.path.basename(os.path.normpath(of_out_dir))}/{self.label}.ini"
        self.plot_path = f"plots/{os.path.basename(os.path.normpath(of_out_dir))}/{self.label}.png"
