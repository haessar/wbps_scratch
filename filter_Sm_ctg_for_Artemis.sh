...
awk -v num="$ctg_num" '$1=="SM_V10_"num' schistosoma_mansoni_gca000000000v1.gff3 > SM_V10_${ctg_num}_anno.gff
awk -v num="$ctg_num" '$1=="SM_V10_"num' schistosoma_mansoni.PRJEA36577.WBPS19.annotations.gff3 > SM_V10_${ctg_num}_wbps.gff

~/Artemis/art -Dblack_belt_mode=false SM_V10_${ctg_num}.fa \
        + SM_V10_${ctg_num}_wbps.gff \
        + SM_V10_${ctg_num}_braker.gff \
        + SM_V10_${ctg_num}_helixer.gff \
        + SM_V10_${ctg_num}_anno.gff
