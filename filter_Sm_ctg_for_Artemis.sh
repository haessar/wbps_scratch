...
awk "/SM_V10_$ctg_num\_/" Schistosoma_mansoni_sm_braker3.gff3 > SM_V10_${ctg_num}_braker.gff
...
~/Artemis/art -Dblack_belt_mode=false SM_V10_${ctg_num}.fa + SM_V10_${ctg_num}_wbps.gff + SM_V10_${ctg_num}_braker.gff
