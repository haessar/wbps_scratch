...
#SBATCH --job-name=Xx_helixer        # some descriptive job name of your choice
...
############# MY CODE #############
apptainer run --nv ../../helixer-docker_helixer_v0.3.3_cuda_11.8.0-cudnn8.sif Helixer.py \
        --model-filepath ../../training/all_wbp_new/full_helixer_model.h5 \
        --subsequence-length 213840 --overlap-offset 106920 --overlap-core-length 160380 \
        --fasta-path $wbps_grant/fasta/XXXXXX \
        --species Xxxxxx_xxxxxx \
        --gff-output-path Xxxxxx_xxxxxx_helixer.gff3
